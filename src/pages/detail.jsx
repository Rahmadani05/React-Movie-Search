                ...
                <div className="max-w-5xl w-full bg-white rounded-xl overflow-hidden shadow-2xl">
                    ...
                    <div className="flex flex-col md:flex-row p-8 gap-8 bg-white">
                        ...
                        <div className="w-full md:w-2/3 flex flex-col gap-6">
                            {/* Plot Box */}
                            <div className="bg-white-100 p-6 rounded-lg border border-gray-300 border-l-4 border-l-primary-light">
                            ...
                            {/* Details Grid */}
                            <div className="bg-primary-yellow/10 p-6 rounded-lg space-y-3 border border-primary-yellow/50">
